                    ...
                    `}>
                            ...
                            <ul className="space-y-3">
                                {plan.features.map((feature, fIdx) => (
                                    <li key={fIdx} className="flex items-center">
                                        <Check
                                            className={`size-5 ${plan.highlighted ? "text-purple-500" : "text-green-500"} mr-2
                                            flex-shrink-0`}
                                        />
                        ...
                        <CardFooter className="mt-auto">
                            ...
                            >
                                ...
                                "Current Plan" : isUserLoaded && plan.id === "month" && isYearlySubscriptionActive ?
                                    ("Yearly Plan Active") : (plan.ctaText)
                                }
                            </Button>
                        </CardFooter>
                    </Card>
